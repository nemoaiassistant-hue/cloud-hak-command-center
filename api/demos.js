...
Generate a JSON object with these exact keys:
{
  ...
  "global_prompt": "IMPORTANT: This is the PRIMARY KNOWLEDGE BASE that the agent draws from. MUST contain: 'You are a helpful agent representing [business name].' Then ALL company info: full address, phone number, email, every service/treatment with description, pricing if available, business hours, booking methods, team info, certifications. Write as factual paragraphs NOT bullet points. End with: 'Keep responses to 1-3 sentences max. No bullet points. Always end with a question. NEVER make up information — only use what is provided above. If asked something not covered, offer to connect them with the team.'",
